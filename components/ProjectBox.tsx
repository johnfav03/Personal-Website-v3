...
export default function Project({ pos, src, title, date, skills, desc, link }: {pos: number, src: string, title: string, date: string, skills: string[], desc: string, link: string}) {
    return (
        <div className="h-[400px] w-60 block relative flex flex-col flex-start">
            ...
            <Image
                ...
                style={{objectPosition: `${((100 + pos) > 0 ? (100 + pos) : 0)}% 100%`, transition: `object-position 1s ease-out`}}
                alt={src}
                height={300}
                width={300}
            />
